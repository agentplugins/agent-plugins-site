...
Agent Plugins is openly licensed and developed in public. Its initial Technical Steering Committee includes Core Maintainers from Amazon, Cursor, Google, Microsoft, OpenAI, and Vercel.
...
<Cards>
  <Card title="Build a plugin" href="/plugin-authors/build-an-agent-plugin" description="Create a portable package with skills and MCP servers." />
  <Card title="Implement a client" href="/client-implementers/implement-an-agent-plugins-client" description="Load, validate, and run Agent Plugins safely." />
